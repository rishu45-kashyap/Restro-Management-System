...
<head>
<meta charset="utf-8">
<title>Restoran Management System</title>
			...
			<div class="container my-5 py-5">
				<div class="row align-items-center g-5">
					...
					<div class="col-lg-6 text-center text-lg-end overflow-hidden">
						<img class="img-fluid" src="img/16.jpg" alt="" style="border-radius: 50%; animation: rotateImage 1000ms linear infinite;">
		...
		<div class="container-xxl py-5">
			<div class="container">
				<div class="row g-4">
					...
					<form id="myfrom" action="ReadFourServiceModule" method="post">
                ...
                ArrayList<ServiceModulePojo> arryList = ( ArrayList<ServiceModulePojo>)session.getAttribute("servicedata");
                for(  ServiceModulePojo pojo : arryList){
